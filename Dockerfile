...
RUN apt-get update && apt dist-upgrade -fuy && apt-get install -y autoconf git build-essential libsdl2-dev libsdl2-ttf-dev libsdl2-image-dev libpng-dev libflac-dev libmpg123-dev libmpeg2-4-dev pkgconf
